...
## OUTPUT:
<img width="1615" height="738" alt="image" src="https://github.com/user-attachments/assets/a7cccb21-b18a-4f4d-8413-33bc757bd280" />


## RESULT:
Thus the program has been executed by using CUDA to mulptiply two matrices. It is observed that there are variations in host and device elapsed time. Device took 0.001323 time and host took 0.000141 time.
